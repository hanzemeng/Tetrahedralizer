public static class TetrahedralizerConstant
{
    public const int UNDEFINED_VALUE = -1; // technically UNDEFINED_VALUE should be uint32_t with a value of 0xFFFFFFFF
    
    public const string TETRAHEDRALIZER_NAME = "Tetrahedralizer";
    public const string TETRAHEDRALIZER_VERSION = "2.0.0";
